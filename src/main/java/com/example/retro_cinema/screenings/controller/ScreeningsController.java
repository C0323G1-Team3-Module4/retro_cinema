...
//    }
    ...
    public String showList(@RequestParam(defaultValue = "0")int page, Model model){
        ...
        Page<Screenings> screeningsPage = screeningsService.getAllPage(pageable);
    ...
    public String add(@Valid @ModelAttribute ScreeningsDto screeningsDto, BindingResult bindingResult, Model model){
